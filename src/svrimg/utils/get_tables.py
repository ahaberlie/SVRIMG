...
def _create_index_table(out_name, haz_type, data_dir="../data/csvs", 
                        url="http://nimbus.niu.edu/svrimg/data/raw_img/", start_year=1996,
                        end_year=2017):
    ...
    url: str
        ...
        Default is "http://nimbus.niu.edu/svrimg/data/".
    start_year: int
        First year from which to return data. Default is 1996.
    end_year: int
        Last year from which to return data. Default is 2017.
...
def get_table(which, haz_type, data_dir="../data/csvs", 
              url="https://nimbus.niu.edu/svrimg/data/"):
    ...
    url: str
        Base url directory where the table data is located. 
        Default is "https://nimbus.niu.edu/svrimg/data/".
...
def get_geog(data_dir="../data/geog/", url="https://nimbus.niu.edu/svrimg/maps/"):
    ...
    url: str
        Base url directory where the table data is located. 
        Default is "https://nimbus.niu.edu/svrimg/maps/".
